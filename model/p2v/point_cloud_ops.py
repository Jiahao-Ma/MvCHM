# 
# REFERENCE: https://github.com/SmallMunich/nutonomy_pointpillars/blob/master/second/core/point_cloud/point_cloud_ops.py
import time
...
def points_to_voxel(points,
    ...
    if reverse_index:
        voxelmap_shape = voxelmap_shape[::-1] # zyx
